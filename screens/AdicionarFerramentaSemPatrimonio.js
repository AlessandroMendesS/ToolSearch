    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
          ...
          <InputField icon="hammer-outline" placeholder="Nome (Ex: Chave de Fenda Phillips)" value={nome} onChangeText={setNome} />
          ...
          <InputField icon="information-circle-outline" placeholder="Detalhes (Ex: Ponta Phillips nº 2, cabo emborrachado)" value={detalhes} onChangeText={setDetalhes} multiline numberOfLines={3} />
          <InputField icon="location-outline" placeholder="Local (Ex: Sala 2, Bancada 1, Gaveta A)" value={local} onChangeText={setLocal} />
