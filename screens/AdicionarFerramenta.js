...
export default function AdicionarFerramenta() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      setProgresso({ atual: qtd, total: qtd }); 
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
          ...
          <InputField icon="hammer-outline" placeholder="Nome (Ex: Furadeira de impacto)" value={nome} onChangeText={setNome} />
          <InputField icon="document-text-outline" placeholder="Número de Patrimônio (apenas números)" value={patrimonio} onChangeText={setPatrimonio} keyboardType="numeric" />
          <InputField icon="copy-outline" placeholder="Quantidade" value={quantidade} onChangeText={(text) => {
          ...
          <InputField icon="information-circle-outline" placeholder="Detalhes (Ex: Com fio, 1000W, para madeira)" value={detalhes} onChangeText={setDetalhes} multiline numberOfLines={3} />
          <InputField icon="location-outline" placeholder="Local (Ex: Sala 1, Armário 3, Gaveta B)" value={local} onChangeText={setLocal} />
