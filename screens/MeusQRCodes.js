...
export default function MeusQRCodes({ navigation }) {
  ...
  const openOptions = (ferramenta) => {
    const qrValue =
      ferramenta.qrcode_url && ferramenta.qrcode_url !== "none"
        ...
        >
          {ferramentasAgrupadas.map((grupo) => {
            ...
            return (
              <View
                key={grupoId}
                style={[styles.grupoContainer, { backgroundColor: theme.card }]}
              >
                <TouchableOpacity
                ...
                >
                  <View style={styles.leftInfo}>
                    ...
                    <View style={styles.nomeContainer}>
                      <Text
                        style={[styles.nomeInline, { color: theme.text }]}
                        numberOfLines={2}
                      >
                        {grupo.nome}
                      </Text>
                ...
                {temMultiplas && estaExpandido ? (
                  ...
                  <View style={styles.qrCodeUnico}>
                    {(() => {
                      const ferramenta =
                        grupo.ferramentas && grupo.ferramentas.length > 0
                          ? grupo.ferramentas[0]
                          : grupo;
                      const qrValue =
                        ferramenta.qrcode_url &&
